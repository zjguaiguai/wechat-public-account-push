export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxc61b09e9b5da7985",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b82656d72579438d4e1931bb29a2acce",
  ...
  USERS: [
    {
      ...
      id: "wxc61b09e9b5da7985",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "i2QgwTgSX3lu8a8yHvVUBFFTSM6Grr0iRQBtSrW0YTs
",
      // 所在省份
      province: "重庆",
      // 所在城市
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "乖乖", "year": "2001", "date": "11-27"},
        {"type": "节日", "name": "在一起纪念日", "year": "2022", "date": "08-28"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "乖乖", "year": "2001", "date": "11-27"},
        {"type": "节日", "name": "相遇纪念日", "year": "2022", "date": "08-28"},
      ],
